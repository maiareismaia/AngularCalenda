...
export class MapaService {
  ...
  iniciarPlantaCanvas(planta){
    if (planta){
      ...
      planta = new fabric.Canvas('planta',
      {
        ...
        width: $('#divwidth').width(), height: 400,
  ...
  adicionarPavimentoInicial(planta){
    ...
    groupPavimento.set("id", "groupPavimento");
    groupPavimento.set("tipo", "pavimento");
    //  , inside: true
...
// 
  ...
  adicionarMesa(planta){
    ...
    var groupMesa = new fabric.Group(mesa, {
      top: 80,
      left: 40,
      // width: 80,
      // height: 40,
    ...
    groupMesa.set("id", "");
    groupMesa.set("tipo", "mesa");
    planta.add(groupMesa);
  ...
  adicionarSala(planta){
    ...
    var groupSala = new fabric.Group(sala, {
      top:80,
      left: 40
    })
    groupSala.set("id", "");
    groupSala.set("tipo", "sala");
    planta.add(groupSala);   
